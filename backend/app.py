...
class ConfigIn(BaseModel):
    ...
    margin_wall: float = Field(default=0.6, ge=0, le=10)
    margin_stage: float = Field(default=0.6, ge=0, le=10)
    margin_aisle: float = Field(default=0.3, ge=0, le=10)
...
def update_config(body: ConfigIn):
    config = {
        ...
        "margin_wall": body.margin_wall,
        "margin_stage": body.margin_stage,
        "margin_aisle": body.margin_aisle,
